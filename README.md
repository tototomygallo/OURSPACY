...
Además del paquete, necesitás instalar el modelo de spaCy del idioma que
vayas a usar (esto **no** se instala automáticamente con pip, hay que
descargarlo aparte):
...
Si intentás calcular LSM en un idioma cuyo modelo no está descargado, vas
a ver un error explicando exactamente qué comando correr.
...
- si alguno de los dos hablantes principales no tiene palabras
  contabilizadas.
...
print(idiomas_soportados())  # ['en', 'es']
```
